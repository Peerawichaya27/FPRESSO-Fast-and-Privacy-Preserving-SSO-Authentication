...
def login():
    ...
    if auth_response.status_code == 200:
        ...
        sso_response = requests.get('http://localhost:8000/authenticate', headers={'username':username, 'appNo': 'app1'})
...
def protected():
    ...
    if token and verify_token(token):
        ...
        verify_response = requests.get('http://localhost:8000/verify', headers={'appNo': 'app1'}, cookies={'sso_token': token_part})
